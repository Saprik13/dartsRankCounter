...
const i18n = {
  uk: {
    ...
    importPlaceholder:
      "Форманюк Андрій\t1003,75\nКорпусов Андрій\t961,25\nТомчук Олег\t862,5\n...",
    ...
    colPlace: "Місце",
    colPoints: "Бали",
    colNewRating: "Новий рейтинг",
    colDetectedAs: "Розпізнане ім'я",
    colConfidence: "Впевненість",
    colTournamentPlace: "Місце в турнірі",
    colCurrentRating: "Поточний рейтинг",
    colEarned: "Отримано балів",
    colChange: "Зміна",
    ...
    detectedCheckDesc:
      "Місця будуть автоматично підставлені — ви зможете виправити будь-яке вручну",
    ...
    scheme4Groups1:
      "• 1-і місця (4 гравці) → одразу в <strong>чвертьфінал</strong>",
    scheme4Groups2: "• 2-3 місця → в <strong>1/8 фіналу</strong>",
    schemeThirdNote: "⚠️ При 2 групах треті місця виходять за замовчуванням",
    qfWinner: "🏆 Переможець",
    qfFinalist: "🥈 Фіналіст",
    qfSemi: "🥉 Півфіналісти",
    qfQuarter: "⚔️ 1/4 фіналу",
    qfEighth: "⚔️ 1/8 фіналу",
    qfGroup3: "📊 Група 3 місце",
    qfClearAll: "🗑️ Очистити всі",
    ...
    summaryType: "Тип",
    summaryPlayers: "Гравців",
    summaryGroups: "Груп",
    summaryThird: "Треті місця",
    summaryCoef: "Коефіцієнт",
    third2groups: "виходять (2 групи)",
    third3groups: "2 кращих (3 групи)",
    thirdNo4: "не виходять (4+ групи)",
    thirdAllYes: "виходять всі",
    thirdAllNo: "не виходять",
    placeWinner: "🏆 Переможець",
    placeFinalist: "🥈 Фіналіст",
    placeSemi: "🥉 Півфіналіст",
    placeQuarter: "⚔️ 1/4 фіналу",
    placeEighth: "⚔️ 1/8 фіналу",
    placeSixteenth: "⚔️ 1/16 фіналу",
    placeGroup: (n) => `📊 Група - ${n} місце`,
    placeSelectDefault: "— Оберіть місце —",
    place1: "🏆 1 місце (переможець)",
    place2: "🥈 2 місце",
    place3: "🥉 3 місце",
    placeN: (n) => `${n} місце`,
    ...
    schemeWinner: "🏆 Переможець",
    schemeFinalist: "🥈 Фіналіст",
    schemeSemi: "🥉 Півфіналісти",
    schemeQuarter: "⚔️ 1/4 фіналу",
    schemeGroup3: "📊 Група - 3 місце",
    schemeGroup4: "📊 Група - 4 місце",
    schemeGroup5: "📊 Група - 5 місце",
    ...
    csvHeader:
      "№,Гравець,Попередній рейтинг,Місце,Отримано балів,Новий рейтинг,Зміна\n",
    csvTitle: "НОВИЙ РЕЙТИНГ ДАРТС",
    copyAlt: "Новий рейтинг скопійовано!",
    imageWrongType:
      "❌ Будь ласка, завантажте зображення (JPG, PNG, GIF, WebP)",
    aiPromptIntro: (n) =>
      `Ти — асистент для розпізнавання результатів турніру з дартсу.\n\nНа зображенні — таблиця результатів турніру з дартсу.\n\nСписок зареєстрованих гравців (${n} осіб):`,
    aiPromptParticipants: (count, groups) =>
      `Кількість учасників: ${count}, груп: ${groups}.`,
  ...
  en: {
    ...
    importPlaceholder:
      "Formaniuk Andrii\t1003.75\nKorpusov Andrii\t961.25\nTomchuk Oleg\t862.5\n...",
    ...
    colPlace: "Place",
    colPoints: "Points",
    colNewRating: "New rating",
    colDetectedAs: "Detected as",
    colConfidence: "Confidence",
    colTournamentPlace: "Tournament place",
    colCurrentRating: "Current rating",
    colEarned: "Points earned",
    colChange: "Change",
    ...
    detectedCheckDesc:
      "Places will be auto-filled — you can correct any of them manually",
    ...
    scheme4Groups1:
      "• Group winners (4 players) → directly to <strong>quarter-final</strong>",
    scheme4Groups2: "• 2nd–3rd places → to <strong>round of 16</strong>",
    schemeThirdNote: "⚠️ With 2 groups, 3rd places advance by default",
    qfWinner: "🏆 Winner",
    qfFinalist: "🥈 Finalist",
    qfSemi: "🥉 Semi-finalists",
    qfQuarter: "⚔️ Quarter-final",
    qfEighth: "⚔️ Round of 16",
    qfGroup3: "📊 Group 3rd place",
    qfClearAll: "🗑️ Clear all",
    ...
    summaryThird: "3rd places",
    summaryCoef: "Coefficient",
    third2groups: "advance (2 groups)",
    third3groups: "2 best (3 groups)",
    thirdNo4: "do not advance (4+ groups)",
    thirdAllYes: "all advance",
    thirdAllNo: "do not advance",
    placeWinner: "🏆 Winner",
    placeFinalist: "🥈 Finalist",
    placeSemi: "🥉 Semi-finalist",
    placeQuarter: "⚔️ Quarter-final",
    placeEighth: "⚔️ Round of 16",
    placeSixteenth: "⚔️ Round of 32",
    placeGroup: (n) =>
      `📊 Group - ${n}${n === 1 ? "st" : n === 2 ? "nd" : n === 3 ? "rd" : "th"} place`,
    placeSelectDefault: "— Select place —",
    place1: "🏆 1st place (winner)",
    place2: "🥈 2nd place",
    place3: "🥉 3rd place",
    placeN: (n) =>
      `${n}${n === 4 ? "th" : n === 5 ? "th" : n === 6 ? "th" : "th"} place`,
    ...
    schemeWinner: "🏆 Winner",
    schemeFinalist: "🥈 Finalist",
    schemeSemi: "🥉 Semi-finalists",
    schemeQuarter: "⚔️ Quarter-final",
    schemeGroup3: "📊 Group - 3rd place",
    schemeGroup4: "📊 Group - 4th place",
    schemeGroup5: "📊 Group - 5th place",
...
function updateTournamentInfo() {
  ...
  if (groupCount === 1) {
    ...
    thirdPlaceNote =
      currentLang === "en"
        ? "Single group — no playoff"
        : "При 1 групі — турнір без плей-офф";
  } else if (thirdPlaceOption === "auto") {
    if (groupCount === 2) {
      thirdPlaceOut = false;
      thirdPlaceNote = t("thirdNote2");
    } else if (groupCount === 3) {
      thirdPlaceOut = false;
      thirdPlaceNote = t("thirdNote3");
    } else {
      thirdPlaceOut = true;
      thirdPlaceNote = t("thirdNote4");
    }
  ...
  if (type === "single_group") {
    ...
    if (table.winner)
      html += `<li><strong>${t("schemeWinner")}:</strong> <span style="color:var(--accent2)">${table.winner.toFixed(2)}</span></li>`;
    if (table.finalist)
      html += `<li><strong>${t("schemeFinalist")}:</strong> <span style="color:#c0c0c0">${table.finalist.toFixed(2)}</span></li>`;
    if (table.semi)
      html += `<li><strong>${t("schemeSemi")}:</strong> <span style="color:#cd7f32">${table.semi.toFixed(2)}</span></li>`;
    if (table.quarter)
      html += `<li><strong>${t("schemeQuarter")}:</strong> ${table.quarter.toFixed(2)}</li>`;
    if (table.group3)
      html += `<li><strong>${t("schemeGroup3")}:</strong> ${table.group3.toFixed(2)}${thirdPlaceOut && count >= 7 ? t("schemeThirdOut") : ""}</li>`;
    if (table.group4)
      html += `<li><strong>${t("schemeGroup4")}:</strong> ${table.group4.toFixed(2)}</li>`;
    if (table.group5)
      html += `<li><strong>${t("schemeGroup5")}:</strong> ${table.group5.toFixed(2)}</li>`;
...
function renderAIResults(results) {
  ...
  const placeLabels = {
    winner: t("placeWinner"),
    finalist: t("placeFinalist"),
    semi: t("placeSemi"),
    quarter: t("placeQuarter"),
    eighth: t("placeEighth"),
    sixteenth: t("placeSixteenth"),
    group3: t("placeGroup", 3),
    group4: t("placeGroup", 4),
  ...
  players.forEach((player) => {
    ...
    const detectedAs = aiResult?.detectedAs || "—";
  ...
  const pct = totalCount ? Math.round((highCount / totalCount) * 100) : 0;
  const badge = document.getElementById("aiConfidenceBadge");
  badge.textContent = t("detectedCount", highCount, totalCount, pct);
  badge.className =
    pct >= 70
      ? "confidence-high"
      : pct >= 40
  ...
  document.getElementById("detectedResults").classList.remove("hidden");
}
...
function renderPlaceAssignment() {
  ...
  if (type === "single_group") {
    ...
    if (groupCount === 1) {
      ...
      if (count >= 4)
        placeOptions += `<option value="quarter">${t("placeN", 4)}</option>`;
      if (count >= 5)
        placeOptions += `<option value="eighth">${t("placeN", 5)}</option>`;
      if (count >= 6)
        placeOptions += `<option value="sixteenth">${t("placeN", 6)}</option>`;
    } else {
      if (table.winner)
        placeOptions += `<option value="winner">${t("placeWinner")}</option>`;
      if (table.finalist)
        placeOptions += `<option value="finalist">${t("placeFinalist")}</option>`;
      if (groupCount <= 3) {
        if (table.semi)
          placeOptions += `<option value="semi">${t("semiNote1")}</option>`;
        if (table.quarter)
          placeOptions += `<option value="quarter">${t("quarterNote")}</option>`;
      } else {
        if (table.quarter)
          placeOptions += `<option value="quarter">${t("quarterNote4")}</option>`;
        if (table.eighth)
          placeOptions += `<option value="eighth">${t("eighthNote")}</option>`;
      }
    }
    for (let i = 3; i <= 5; i++) {
      const key = "group" + i;
  ...
  players.forEach((player, index) => {
    let detectedPlace = "";
    for (let d of detectedPlayersFromImage) {
      if (d.matched === player.name) {
        detectedPlace = d.place;
        break;
      }
    }
    const row = document.createElement("div");
...
function updatePlayerPoints(index) {
  ...
  if (!placeValue) {
    ...
    if (
      table &&
      table[placeValue] !== undefined &&
      table[placeValue] !== null
    ) {
      points = table[placeValue];
    } else {
      const coef =
        coefficients[count] !== undefined ? coefficients[count] : 1.5;
  ...
  document.getElementById("points_" + index).textContent =
    "+" + formatRating(points);
  document.getElementById("newRating_" + index).textContent = formatRating(
    players[index].newRating,
  );
}
...
function renderResults() {
  ...
  players.forEach((player, index) => {
    ...
    if (player.placeValue) {
      ...
      if (map[player.placeValue]) {
        placeText = map[player.placeValue][0];
        badgeClass = map[player.placeValue][1];
      } else if (player.placeValue.startsWith("group")) {
        placeText = t(
          "placeGroup",
          parseInt(player.placeValue.replace("group", ""), 10),
        );
...
function exportToCSV() {
  ...
  link.download =
    "darts_rating_" + new Date().toISOString().slice(0, 10) + ".csv";
  link.click();
}
